...
SELECT DEPARTMENT_ID, COUNT(*), ROUND(AVG(SALARY)) FROM EMPLOYEES GROUP BY DEPARTMENT_ID;
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE(VJOB_ID||'|'||VSALARY||'|'||VHIRE_DATE||'|'||VCOMMISSION_PCT||'|'||VDEPARTMENT_NAME);
END;
